...
{
    public partial class CategoryCase
    {
        ...
        public virtual SpecColor ColorNavigation { get; set; }
        public virtual SpecCaseFormFactor FormFactorNavigation { get; set; }
        public virtual SpecManufacturer ManufacturerNavigation { get; set; }
        public virtual SpecCaseMaterial MaterialNavigation { get; set; }
        public virtual SpecMotherboardFormFactor MotherboardFormFactorNavigation { get; set; }
